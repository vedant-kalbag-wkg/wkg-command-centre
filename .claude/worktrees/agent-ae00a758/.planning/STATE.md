...
last_updated: "2026-04-01T16:55:00.173Z"
...
| Phase 04.1 P01 | 30 | 2 tasks | 3 files |
...
- [Phase 04.1]: Assets column routes to kiosk.hardwareSerialNumber (not location.hardwareAssets) — confirmed bug in Phase 4 field-mapper.ts KNOWN_FIELD_MAP
- [Phase 04.1]: normaliseLocationName strips [outlet_code] suffix for location dedup key — same hotel name with different outlet codes merge into one location record
- [Phase 04.1]: MergeConflict type defined before ImportPreview in field-mapper.ts types section — avoids TypeScript forward reference in interface field
...
Last session: 2026-04-01T16:54:51.748Z
