...
const createKioskSchema = z.object({
  ...
  customerCode1: z.string().optional(),
  customerCode2: z.string().optional(),
...
export type KioskWithRelations = {
  ...
  customerCode1: string | null;
  customerCode2: string | null;
  ...
  try {
    ...
    const [newKiosk] = await db
      ...
      .values({
        ...
        customerCode1: validated.customerCode1 || null,
        customerCode2: validated.customerCode2 || null,
