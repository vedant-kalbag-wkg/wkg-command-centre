...
- [ ] **MIGR-01**: Admin can trigger a Monday.com data import that maps Monday.com board columns to kiosk/location fields
- [ ] **MIGR-02**: Migration supports dry-run mode (preview imported data before committing)
- [ ] **MIGR-03**: Migration handles pagination and rate limits for 1,000+ records
