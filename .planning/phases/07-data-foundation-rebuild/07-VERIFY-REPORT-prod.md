...
|-----------|--------|----------|--------|--------|
| locations.active count vs golden | FAIL | 373 | 510 |  |
| kiosks.active count vs golden | FAIL | 442 | 400 |  |
...
| locations.customer_code coverage (Phase 07-06 Pass 0 input) | PASS | >= 320 | 372 | Pass 0 resolution path has expected data shape |
