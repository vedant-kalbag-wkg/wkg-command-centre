...
last_updated: "2026-04-01T17:34:27.725Z"
...
**Current focus:** Phase 04.1 — data-migration-quality-correctness-inserted

## Current Position

Phase: 04.1 (data-migration-quality-correctness-inserted) — EXECUTING
Plan: 4 of 6
...
| Phase 04-data-migration P00 | 8 | 2 tasks | 5 files |
| Phase 04-data-migration P02 | 25 | 1 tasks | 3 files |
| Phase 04.1 P04 | 8 | 2 tasks | 2 files |
| Phase 04.1-data-migration-quality-correctness-inserted P03 | 8 | 2 tasks | 2 files |
| Phase 04.1-data-migration-quality-correctness-inserted P06 | 12 | 2 tasks | 6 files |
...
- [Phase 04-data-migration]: vitest.config.ts excludes tests/** to avoid vitest picking up Playwright spec files
- [Phase 04-data-migration]: locationProducts.providerId nullable — not all products have an assigned provider at import time (per D-12)
- [Phase 04-data-migration]: Select onValueChange receives string | null — handler must guard against null (base-ui Select type contract)
- [Phase 04.1]: keyContactName extracted from keyContacts[0].name in listLocations return mapping — avoids separate DB query
- [Phase 04.1-03]: Asset column (hardwareSerialNumber) is first data column in kiosk table and renders as clickable link to detail page — kioskId hidden by default but togglable
- [Phase 04.1-06]: Used fetchAllItems directly in importConfigGroups — exploreBoardColumns returns columns/mappings only, not items
...
Last session: 2026-04-01T17:34:27.723Z
