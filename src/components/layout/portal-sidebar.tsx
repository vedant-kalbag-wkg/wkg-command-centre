...
const analyticsItems = [
  { title: "Portfolio", href: "/portal/analytics/portfolio", icon: BarChart3 },
  { title: "Heat Map", href: "/portal/analytics/heat-map", icon: Grid3X3 },
  {
    title: "Trend Builder",
    href: "/portal/analytics/trend-builder",
    icon: TrendingUp,
  },
  {
    title: "Hotel Groups",
    href: "/portal/analytics/hotel-groups",
    icon: Building2,
  },
  { title: "Regions", href: "/portal/analytics/regions", icon: Globe },
];
